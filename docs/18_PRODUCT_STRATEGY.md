...
Owner can create, edit, activate, deactivate, or remove occasions from the dashboard.
...
Display related products based on historical purchasing patterns.
