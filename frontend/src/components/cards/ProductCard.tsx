      ...
      <div className="p-5 flex-1 flex flex-col justify-between space-y-3">
        <div>
          <div className="flex items-center gap-1 text-amber-500 text-xs font-bold mb-1">
            ...
            <span className="text-[#6E5D4F]">({product.reviewCount})</span>
          </div>
        ...
        <div className="pt-3 border-t border-[#E8E2D9] flex items-center justify-between">
          ...
          <button
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-[#E67E22] text-white text-xs font-semibold hover:bg-[#D35400] transition-colors"
          >
