...
export const UnauthorizedPage: React.FC = () => {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center p-6 space-y-4">
      ...
      <h1 className="text-3xl font-extrabold text-[#2C1E16]">403 - Access Denied</h1>
      <p className="text-sm text-[#6E5D4F] max-w-md">
...
export const SessionExpiredPage: React.FC = () => {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center p-6 space-y-4">
      <ShieldAlert className="h-16 w-16 text-[#E67E22]" />
      <h1 className="text-3xl font-extrabold text-[#2C1E16]">Session Expired</h1>
      <p className="text-sm text-[#6E5D4F] max-w-md">
